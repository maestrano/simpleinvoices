...
# Configure SimpleInvoices Connec! configuration using Ansible
...
ansible-playbook /etc/ansible/playbooks/configure_simpleinvoices.yml -c local --extra-vars="${extra_vars}"
